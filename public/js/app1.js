...
/* WEBPACK VAR INJECTION */(function($) {var Vue = __webpack_require__(4);
var VueResource = __webpack_require__(3);
var stepList = __webpack_require__(7);
Vue.use(VueResource);
...
var app4 = new Vue({
	...
	methods: {
		addStep: function addStep(step) {
			...
			if (step) {
				resource.save('', { name: step }).then(function (response) {
					_this.fetchSteps();
				}, function (response) {
					response.status;
				});
		...
		toggleCompletion: function toggleCompletion(step) {
			var _this2 = this;

			resource.update({ id: step.id }, { opposite: !step.completed }).then(function (response) {
				_this2.fetchSteps();
			}, function (response) {
				response.status;
			});
		...
		removeStep: function removeStep(step) {
			...
			resource.delete({ id: step.id }).then(function (response) {
				_this3.fetchSteps();
			}, function (response) {
				response.status;
			});
		...
		completeAll: function completeAll() {
			...
			this.$http.post(this.baseURL + '/complete').then(function (response) {
				_this4.fetchSteps();
			}, function (response) {
				response.status;
			});
		...
		clearCompleted: function clearCompleted() {
			...
			this.$http.delete(this.baseURL + '/clear').then(function (response) {
				_this5.fetchSteps();
			}, function (response) {
				response.status;
			});
		...
		fetchSteps: function fetchSteps() {
			...
			resource.get().then(function (response) {
				Vue.set(_this6, 'steps', response.body);
			}, function (response) {
				response.status;
			});
		}
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    }, _defineProperty(_methods, 'editStep', function editStep(step) {
        this.removeStep(step);
        this.newStep = step.name;
        this.$refs.newStep.focus();
    }), _defineProperty(_methods, 'clearCompleted', function clearCompleted() {
        this.$emit('clear');
    }), _methods),
    computed: {
        completeSteps: function completeSteps() {
        ...
        typeSwitch: function typeSwitch() {
            var vm = this;
            if (vm.type == 'remaings') {
                return this.steps.filter(function (step) {
                    if (step.completed == false) return step;
...
/* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
!function (t, n) {
  "object" == ( false ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = n() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (n),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : t.VueResource = n();
}(this, function () {
  "use strict";
  function t(t) {
    ...
    return new n(function (n) {
      var e = new XDomainRequest(),
          o = function o(_o) {
        var r = _o.type,
            i = 0;"load" === r ? i = 200 : "error" === r && (i = 500), n(t.respondWith(e.responseText, { status: i }));
      };t.abort = function () {
        return e.abort();
    ...
    return new n(function (n) {
      var e,
        ...
        var r = _e.type,
            s = 0;"load" === r && null !== u ? s = 200 : "error" === r && (s = 500), n(t.respondWith(u, { status: s })), delete window[i], document.body.removeChild(o);
...
Component.options.__file = "/home/vagrant/Code/TaskManager/resources/assets/js/vue/components/stepList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] stepList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-77163851", Component.options)
  } else {
    hotAPI.reload("data-v-77163851", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.remains.length && _vm.type == 'remaings') ? _c('h2', [_vm._v("待完成的步骤（" + _vm._s(_vm.remains.length) + "）\n                    "), _c('button', {
    staticClass: "btn btn-info btn-sm",
    on: {
      "click": _vm.completeAll
    }
  }, [_vm._v("完成所有")])]) : _vm._e(), _vm._v(" "), (_vm.completions.length && _vm.type == 'completed') ? _c('h2', [_vm._v("已完成的步骤（" + _vm._s(_vm.completions.length) + "）\n                    "), _c('button', {
    staticClass: "btn btn-danger btn-sm",
    on: {
      "click": _vm.clearCompleted
    }
  }, [_vm._v("清除所有")])]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "panel-body"
  }, [_c('ul', {
    staticClass: "list-group"
  }, _vm._l((_vm.typeSwitch), function(step) {
    return _c('transition', {
      ...
      staticClass: "list-group-item animated rollIn"
    }, [_c('span', {
      on: {
    ...
    }, [_vm._v(_vm._s(step.name))]), _vm._v(" "), _c('span', {
      staticClass: "pull-right"
    }, [_c('i', {
      staticClass: "fa fa-check ",
      on: {
        "click": function($event) {
          _vm.toggleCompletion(step)
        }
      }
    }), _vm._v(" "), _c('i', {
  ...
  }))])]) : _vm._e(), _vm._v(" "), (_vm.type == 'remaings') ? _c('div', {
    staticClass: "panel panel-default"
  }, [_c('div', {
    staticClass: "panel-heading"
  }, [_c('div', {
  ...
  }, [(!_vm.newStep) ? _c('label', {
    attrs: {
      "for": "label_step"
    }
  }, [_vm._v("完成这任务需要哪些步骤呢？")]) : _c('label', {
    attrs: {
      "for": "label_step"
    }
  }, [_vm._v("正在输入中....")])])]), _vm._v(" "), _c('div', {
    staticClass: "panel-body"
  }, [_c('form', {
    staticClass: "form-inline-fullwith",
    on: {
    ...
    staticClass: "form-group"
  }, [(this.newStep) ? _c('button', {
    staticClass: "btn btn-primary",
    attrs: {
      "type": "submit"
    }
  }, [_vm._v("添加步骤")]) : _vm._e()])])])]) : _vm._e()])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-77163851", module.exports)
  }
}
...
var update = __webpack_require__(11)("37bed464", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-77163851!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stepList.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-77163851!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stepList.vue");
